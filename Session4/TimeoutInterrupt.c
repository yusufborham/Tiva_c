...
int main(){
    ...
    // Enable the timeout and match interrupt for Wide Timer0A (Overflow and match interrupt)
    TimerIntEnable(WTIMER0_BASE,TIMER_TIMA_TIMEOUT);

    // Clear the interrupt status of Wide Timer0A for both the timeout and match interrupt
